		...
		<div class="row">
			...
			<form role="form" action="/admin/product/update" method="post">
					<div class="form-group">
						<label>상품코드</label>
						<input class="form-control" name='productCode' value='${board.productCode }'>
					</div>
					...
					<div class="form-group">
						<label>운영체제</label>
						<input type="form-control" name='os' value='${board.os }'>
					</div>
					<div class="form-group">
						<label>상품종류</label>
						<input type="form-control" name='productType' value='${board.productType }'>
					</div>
					<div class="form-group">
						<label>재고</label>
						<input type="form-control" name='stock' value='${board.stock }'>
					</div>
					<div class="form-group">
						<label>용도</label>
						<input type="form-control" name='usability' value='${board.usability }'>
					</div>
