				...
				<div class="product product-details clearfix">
					...
					<div class="col-md-6">
						<div class="product-body">
							...
							<p><button onclick="location.href='/admin/update?productCode=${board.productCode}'">update</button></p>
							<p><button onclick="location.href='/admin/delete?productCode=${board.productCode}'">delete</button></p>
